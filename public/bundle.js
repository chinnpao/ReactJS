...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: name, message: 'This is content page.' }), document.getElementById('app'));
	...
	var Greeter = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(GreeterForm, { onChangeData: this.handleNewData })
			);
		}
	});
